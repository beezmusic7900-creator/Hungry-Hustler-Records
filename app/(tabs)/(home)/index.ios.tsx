...
export default function HomeScreen() {
  ...
  function handleAdminPress() {
    if (isAdminUser) {
      console.log('[HomeScreen iOS] Admin panel button pressed — navigating to admin panel');
      router.push('/(tabs)/admin');
    } else {
      console.log('[HomeScreen iOS] Admin login button pressed — navigating to auth screen');
      router.push('/auth');
    }
  }
