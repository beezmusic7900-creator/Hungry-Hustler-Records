...
export default function HomeScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('[HomeScreen iOS] Fetching homepage content and videos');
      ...
      if (homepageResult.status === 'fulfilled') {
        ...
        console.log('[HomeScreen iOS] Could not fetch homepage content:', homepageResult.reason);
        setContent(null);
      }
      ...
      if (videosResult.status === 'fulfilled') {
        ...
        console.log('[HomeScreen iOS] Videos data received:', videosData);
        ...
        console.log('[HomeScreen iOS] Mapped exclusive videos:', mapped.length);
        setExclusiveVideos(mapped);
      } else {
        console.log('[HomeScreen iOS] Could not fetch videos:', videosResult.reason);
        setExclusiveVideos([]);
      }
    } catch (error) {
      console.error('[HomeScreen iOS] Error in fetchData:', error);
      setContent(null);
    } finally {
      setLoading(false);
    }
                  ...
                  <View style={styles.videoInfo}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        console.log('[HomeScreen iOS] Watch Now pressed:', url);
                        router.push({
