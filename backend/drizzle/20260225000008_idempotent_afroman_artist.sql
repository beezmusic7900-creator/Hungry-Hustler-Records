CREATE UNIQUE INDEX IF NOT EXISTS artists_name_unique ON artists (name);--> statement-breakpoint
INSERT INTO artists (id, name, bio, photo_url, created_at, updated_at)
VALUES (
  gen_random_uuid(),
  'Afroman',
